...
When diagnosing hangs, controls resetting, focus loss, or dialogs failing after a UI/form change, read [references/reactive-ui-failures.md](references/reactive-ui-failures.md). Trace the rendering and asynchronous lifecycle beyond the click handler; verify a causal mechanism before adding refreshes, delays, or changing access guards.
